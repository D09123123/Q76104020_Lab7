...
class GameView:
    ...
    def draw_money(self, money: int):
        ...
        text = self.font.render(f"Money: {money}", True, (255, 255, 255))   # create the money information and words
        self.win.blit(text, (5, 45))                                        # draw the money information and words

    def draw_wave(self, wave: int):
        """(Q2.2)render the wave"""
        text = self.font.render(f"Wave: {wave}", True, (255, 255, 255))     # create the wave information and words
        self.win.blit(text, (5, 15))                                        # draw the wave information and words
