...
class GameControl:
    ...
    def update_view(self):
        ...
        self.view.draw_money(self.model.money)            # draw the data of money on on the screen
        self.view.draw_wave(self.model.wave)              # draw the data of wave on on the screen
