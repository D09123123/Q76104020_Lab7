        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if self.sound_btn.clicked(x, y) == True:          # if we click sound button
                        pygame.mixer.music.unpause()                  # play the music
                    if self.mute_btn.clicked(x, y) == True:           # if we click mute button
            ...
            for btn in self.buttons:                # for the buttons we can click
                if btn.clicked(x, y) == True:       # if our mouse position is on the selected button
                    btn.create_frame(x, y)          # create the white frame according to the button we select from class Buttons
